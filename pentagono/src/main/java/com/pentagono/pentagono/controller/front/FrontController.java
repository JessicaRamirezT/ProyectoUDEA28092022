...
public class FrontController {
    ...
    @PostMapping("/employeeN")
    public String createEmployee(Employee empl, RedirectAttributes redirectAttributes) {
    ...
    public String TransactionN(Model model, @ModelAttribute("mensaje") String mensaje) {
        Employee empl = new Employee();
        model.addAttribute("empl", empl);
        model.addAttribute("mensaje", mensaje);
        List<Transaction> listaTransacciones = iTransactionService.getAllTransactions();
        model.addAttribute("transactionlist", listaTransacciones);
        return "new_transaction"; //Llamar HTML
